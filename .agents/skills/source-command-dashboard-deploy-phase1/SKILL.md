---
name: "source-command-dashboard-deploy-phase1"
description: "Phase 1 — build the lifetime rollup by hand, then enable its hourly timer"
---

# source-command-dashboard-deploy-phase1

Use this skill when the user asks to run the migrated source command `dashboard-deploy-phase1`.
