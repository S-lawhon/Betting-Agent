---
name: "source-command-dashboard-deploy-phase0"
description: "Phase 0 — deploy the code; the engine starts writing snapshots. Nothing serves differently."
---

# source-command-dashboard-deploy-phase0

Use this skill when the user asks to run the migrated source command `dashboard-deploy-phase0`.
