...
3. **MLB matching pending regular season markets on Polymarket** — MLB regular season started March 20 but Polymarket's series_id=3 still returns stale spring training markets. Once Polymarket lists game-day markets for regular season games, matching will work automatically (team name formats are identical between venues). P-001 (Kalshi) has `KXMLBGAME` prefix configured and ready.
