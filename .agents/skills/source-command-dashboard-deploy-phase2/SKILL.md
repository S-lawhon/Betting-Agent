---
name: "source-command-dashboard-deploy-phase2"
description: "Phase 2 — start the standalone dashboard on :8081 alongside the old one, then prove it survives the engine dying"
---

# source-command-dashboard-deploy-phase2

Use this skill when the user asks to run the migrated source command `dashboard-deploy-phase2`.
