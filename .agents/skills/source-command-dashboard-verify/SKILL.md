---
name: "source-command-dashboard-verify"
description: "Read-only health check of the whole dashboard data plane (safe anytime)"
---

# source-command-dashboard-verify

Use this skill when the user asks to run the migrated source command `dashboard-verify`.
